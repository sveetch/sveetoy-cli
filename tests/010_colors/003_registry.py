...
@pytest.mark.parametrize("registry_sample,attempted_names,attempted_hexas", [
    (
        [
            ('foo', '#ffffff'),
            ('bar', '#c0c0c0'),
...
def test_get_registry_maps(registry_sample, attempted_names, attempted_hexas):
    """
    ...
    assert names == attempted_names

    assert hexas == attempted_hexas
