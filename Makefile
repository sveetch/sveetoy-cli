...
help:
	...
	@echo "  flake               -- to launch Flake8 checking on sveetoy_cli code (not the tests)"
...
clean: delpyc
	rm -Rf venv dist .tox sveetoy_cli.egg-info .cache tests/__pycache__/
